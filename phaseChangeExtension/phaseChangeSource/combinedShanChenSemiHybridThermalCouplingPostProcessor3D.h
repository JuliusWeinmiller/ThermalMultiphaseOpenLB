 ...
 * -- header file.
 */
#ifndef COMBINED_SEMI_HYBRID_THERMAL_COUPLING_POST_PROCESSOR_3D_H
#define COMBINED_SEMI_HYBRID_THERMAL_COUPLING_POST_PROCESSOR_3D_H
...
class CombinedShanChenSemiHybridThermalCouplingPostProcessor3D :
...
template<typename T, typename DESCRIPTOR>
class CombinedShanChenSemiHybridThermalCouplingGenerator3D :

 ...
 * -- header file.
 */
#ifndef COMBINED_THERMAL_MRT_COUPLING_POST_PROCESSOR_3D_H
#define COMBINED_THERMAL_MRT_COUPLING_POST_PROCESSOR_3D_H
...
class CombinedShanChenThermalMRTCouplingPostProcessor3D :
...
template<typename T, typename DESCRIPTOR>
class CombinedShanChenThermalMRTCouplingGenerator3D :

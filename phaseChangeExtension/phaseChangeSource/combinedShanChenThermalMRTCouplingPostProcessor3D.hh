 ...
 */
#ifndef COMBINED_THERMAL_MRT_COUPLING_POST_PROCESSOR_3D_HH
#define COMBINED_THERMAL_MRT_COUPLING_POST_PROCESSOR_3D_HH
...
CombinedShanChenThermalMRTCouplingPostProcessor3D<T,DESCRIPTOR>::
CombinedShanChenThermalMRTCouplingPostProcessor3D(
...
template<typename T, typename DESCRIPTOR>
void CombinedShanChenThermalMRTCouplingPostProcessor3D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
CombinedShanChenThermalMRTCouplingGenerator3D<T,DESCRIPTOR>::
CombinedShanChenThermalMRTCouplingGenerator3D(
    int x0_, int x1_, int y0_, int y1_,int z0_, int z1_,
    T G_, T Tomega_,
    T averageRho_, T gravity_, std::vector<T> dir_,
    FluidProperties<T>& fluidProperties_,
...
template<typename T, typename DESCRIPTOR>
PostProcessor3D<T,DESCRIPTOR>* CombinedShanChenThermalMRTCouplingGenerator3D<T,DESCRIPTOR>::generate (
  std::vector<SpatiallyExtendedObject3D* > partners) const
{
  return new CombinedShanChenThermalMRTCouplingPostProcessor3D<T,DESCRIPTOR>(
...
template<typename T, typename DESCRIPTOR>
LatticeCouplingGenerator3D<T,DESCRIPTOR>* CombinedShanChenThermalMRTCouplingGenerator3D<T,DESCRIPTOR>::clone() const
{
  return new CombinedShanChenThermalMRTCouplingGenerator3D<T,DESCRIPTOR>(*this);
}

 ...
 */
#ifndef COMBINED_SEMI_HYBRID_THERMAL_MRT_COUPLING_POST_PROCESSOR_2D_HH
#define COMBINED_SEMI_HYBRID_THERMAL_MRT_COUPLING_POST_PROCESSOR_2D_HH
...
CombinedShanChenSemiHybridThermalMRTCouplingPostProcessor2D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
void CombinedShanChenSemiHybridThermalMRTCouplingPostProcessor2D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
CombinedShanChenSemiHybridThermalMRTCouplingGenerator2D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
PostProcessor2D<T,DESCRIPTOR>* CombinedShanChenSemiHybridThermalMRTCouplingGenerator2D<T,DESCRIPTOR>::generate (
  std::vector<SpatiallyExtendedObject2D* > partners) const
{
  return new CombinedShanChenSemiHybridThermalMRTCouplingPostProcessor2D<T,DESCRIPTOR>(
...
template<typename T, typename DESCRIPTOR>
LatticeCouplingGenerator2D<T,DESCRIPTOR>* CombinedShanChenSemiHybridThermalMRTCouplingGenerator2D<T,DESCRIPTOR>::clone() const
{
  return new CombinedShanChenSemiHybridThermalMRTCouplingGenerator2D<T,DESCRIPTOR>(*this);
}

 ...
 * -- header file.
 */
#ifndef COMBINED_THERMAL_COUPLING_POST_PROCESSOR_2D_H
#define COMBINED_THERMAL_COUPLING_POST_PROCESSOR_2D_H
...
class CombinedShanChenThermalCouplingPostProcessor2D :
...
private:
  ...
  BlockLattice2D<T,descriptors::D2Q5<descriptors::VELOCITY,
...
template<typename T, typename DESCRIPTOR>
class CombinedShanChenThermalCouplingGenerator2D :

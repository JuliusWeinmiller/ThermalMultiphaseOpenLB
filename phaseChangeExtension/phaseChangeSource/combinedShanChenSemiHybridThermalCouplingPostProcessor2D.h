 ...
 * -- header file.
 */
#ifndef COMBINED_SEMI_HYBRID_THERMAL_COUPLING_POST_PROCESSOR_2D_H
#define COMBINED_SEMI_HYBRID_THERMAL_COUPLING_POST_PROCESSOR_2D_H
...
class CombinedShanChenSemiHybridThermalCouplingPostProcessor2D :
...
template<typename T, typename DESCRIPTOR>
class CombinedShanChenSemiHybridThermalCouplingGenerator2D :

 ...
 */
#ifndef COMBINED_SEMI_HYBRID_THERMAL_COUPLING_POST_PROCESSOR_3D_HH
#define COMBINED_SEMI_HYBRID_THERMAL_COUPLING_POST_PROCESSOR_3D_HH
...
CombinedShanChenSemiHybridThermalCouplingPostProcessor3D<T,DESCRIPTOR>::
CombinedShanChenSemiHybridThermalCouplingPostProcessor3D(
     ...
     partners(partners_)
{
  ...
  tPartner = dynamic_cast<BlockLattice3D<T,descriptors::D3Q7<descriptors::VELOCITY, descriptors::PHI_THERMAL, descriptors::PREV_T_V, descriptors::PREV_PHI>> *>(partners[0]);
...
template<typename T, typename DESCRIPTOR>
void CombinedShanChenSemiHybridThermalCouplingPostProcessor3D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
CombinedShanChenSemiHybridThermalCouplingGenerator3D<T,DESCRIPTOR>::
CombinedShanChenSemiHybridThermalCouplingGenerator3D(
    int x0_, int x1_, int y0_, int y1_,int z0_, int z1_,
    T G_, T Tomega_,
    T averageRho_, T gravity_, std::vector<T> dir_,
    FluidProperties<T>& fluidProperties_,
...
template<typename T, typename DESCRIPTOR>
PostProcessor3D<T,DESCRIPTOR>* CombinedShanChenSemiHybridThermalCouplingGenerator3D<T,DESCRIPTOR>::generate (
  std::vector<SpatiallyExtendedObject3D* > partners) const
{
  return new CombinedShanChenSemiHybridThermalCouplingPostProcessor3D<T,DESCRIPTOR>(
...
template<typename T, typename DESCRIPTOR>
LatticeCouplingGenerator3D<T,DESCRIPTOR>* CombinedShanChenSemiHybridThermalCouplingGenerator3D<T,DESCRIPTOR>::clone() const
{
  return new CombinedShanChenSemiHybridThermalCouplingGenerator3D<T,DESCRIPTOR>(*this);
}

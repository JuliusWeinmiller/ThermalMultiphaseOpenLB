 ...
 */
#ifndef COMBINED_THERMAL_COUPLING_POST_PROCESSOR_2D_HH
#define COMBINED_THERMAL_COUPLING_POST_PROCESSOR_2D_HH
...
CombinedShanChenThermalCouplingPostProcessor2D<T,DESCRIPTOR>::
CombinedShanChenThermalCouplingPostProcessor2D(
...
template<typename T, typename DESCRIPTOR>
void CombinedShanChenThermalCouplingPostProcessor2D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
CombinedShanChenThermalCouplingGenerator2D<T,DESCRIPTOR>::
CombinedShanChenThermalCouplingGenerator2D(
    int x0_, int x1_, int y0_, int y1_,
    T G_, T Tomega_,
    T averageRho_, T gravity_, std::vector<T> dir_,
    FluidProperties<T>& fluidProperties_,
...
template<typename T, typename DESCRIPTOR>
PostProcessor2D<T,DESCRIPTOR>* CombinedShanChenThermalCouplingGenerator2D<T,DESCRIPTOR>::generate (
  std::vector<SpatiallyExtendedObject2D* > partners) const
{
  return new CombinedShanChenThermalCouplingPostProcessor2D<T,DESCRIPTOR>(
...
template<typename T, typename DESCRIPTOR>
LatticeCouplingGenerator2D<T,DESCRIPTOR>* CombinedShanChenThermalCouplingGenerator2D<T,DESCRIPTOR>::clone() const
{
  return new CombinedShanChenThermalCouplingGenerator2D<T,DESCRIPTOR>(*this);
}

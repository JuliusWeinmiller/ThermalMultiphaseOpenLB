 ...
 */
#ifndef COMBINED_THERMAL_MRT_COUPLING_POST_PROCESSOR_2D_HH
#define COMBINED_THERMAL_MRT_COUPLING_POST_PROCESSOR_2D_HH
...
CombinedShanChenThermalMRTCouplingPostProcessor2D<T,DESCRIPTOR>::
CombinedShanChenThermalMRTCouplingPostProcessor2D(
     ...
     partners(partners_)
{
  ...
  tPartner = dynamic_cast<BlockLattice2D<T,descriptors::D2Q5<descriptors::tag::MRT,descriptors::VELOCITY, descriptors::PHI_THERMAL, descriptors::PREV_T_V, descriptors::PREV_PHI>> *>(partners[0]);
...
template<typename T, typename DESCRIPTOR>
void CombinedShanChenThermalMRTCouplingPostProcessor2D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
CombinedShanChenThermalMRTCouplingGenerator2D<T,DESCRIPTOR>::
CombinedShanChenThermalMRTCouplingGenerator2D(
    int x0_, int x1_, int y0_, int y1_,
    T G_, T Tomega_,
    T averageRho_, T gravity_, std::vector<T> dir_,
    FluidProperties<T>& fluidProperties_,
...
template<typename T, typename DESCRIPTOR>
PostProcessor2D<T,DESCRIPTOR>* CombinedShanChenThermalMRTCouplingGenerator2D<T,DESCRIPTOR>::generate (
  std::vector<SpatiallyExtendedObject2D* > partners) const
{
  return new CombinedShanChenThermalMRTCouplingPostProcessor2D<T,DESCRIPTOR>(
...
template<typename T, typename DESCRIPTOR>
LatticeCouplingGenerator2D<T,DESCRIPTOR>* CombinedShanChenThermalMRTCouplingGenerator2D<T,DESCRIPTOR>::clone() const
{
  return new CombinedShanChenThermalMRTCouplingGenerator2D<T,DESCRIPTOR>(*this);
}

 ...
 * -- header file.
 */
#ifndef COMBINED_THERMAL_MRT_COUPLING_POST_PROCESSOR_2D_H
#define COMBINED_THERMAL_MRT_COUPLING_POST_PROCESSOR_2D_H
...
class CombinedShanChenThermalMRTCouplingPostProcessor2D :
...
template<typename T, typename DESCRIPTOR>
class CombinedShanChenThermalMRTCouplingGenerator2D :

 ...
 */
#ifndef COMBINED_THERMAL_COUPLING_POST_PROCESSOR_3D_HH
#define COMBINED_THERMAL_COUPLING_POST_PROCESSOR_3D_HH
...
CombinedShanChenThermalCouplingPostProcessor3D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
void CombinedShanChenThermalCouplingPostProcessor3D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
CombinedShanChenThermalCouplingGenerator3D<T,DESCRIPTOR>::
...
template<typename T, typename DESCRIPTOR>
PostProcessor3D<T,DESCRIPTOR>* CombinedShanChenThermalCouplingGenerator3D<T,DESCRIPTOR>::generate (
  std::vector<SpatiallyExtendedObject3D* > partners) const
{
  return new CombinedShanChenThermalCouplingPostProcessor3D<T,DESCRIPTOR>(
...
template<typename T, typename DESCRIPTOR>
LatticeCouplingGenerator3D<T,DESCRIPTOR>* CombinedShanChenThermalCouplingGenerator3D<T,DESCRIPTOR>::clone() const
{
  return new CombinedShanChenThermalCouplingGenerator3D<T,DESCRIPTOR>(*this);
}
